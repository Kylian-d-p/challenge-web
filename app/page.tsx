      ...
      <section className="bg-gradient-to-b from-primary/5 to-background pt-8 pb-16">
        <div className="max-w-5xl mx-auto px-6 text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Transformez votre corps et votre esprit avec Fit&Flex. Réservez vos
            cours en ligne et rejoignez une communauté passionnée de fitness.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Réservez vos cours à tout moment, 24h/24
              </p>
            </Card>
            ...
            <Card className="p-8 text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Yoga, CrossFit, Pilates et bien plus encore
              </p>
            </Card>
      ...
      <section className="py-18 bg-primary/5 mt-18">
        <div className="max-w-3xl mx-auto px-6 text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            Créez votre compte et réservez votre premier cours gratuitement
          </p>
